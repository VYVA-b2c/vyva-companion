...
CREATE INDEX IF NOT EXISTS idx_social_room_visits_user ON social_room_visits (user_id, entered_at DESC);
CREATE INDEX IF NOT EXISTS idx_social_room_sessions_date ON social_room_sessions (room_id, session_date DESC);
CREATE INDEX IF NOT EXISTS idx_social_rooms_category ON social_rooms (category, is_active);
