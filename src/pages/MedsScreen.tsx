...
const MedsScreen = () => {
  ...
  return (
    <div className="px-[22px]">
      {/* Hero */}
      <div className="mt-[14px] rounded-[22px] p-5 relative overflow-hidden" style={{ background: "#6B21A8" }}>
        ...
        <div className="flex items-center gap-3 mb-3">
          <div className="w-[52px] h-[52px] rounded-[16px] flex items-center justify-center" style={{ background: "rgba(255,255,255,0.14)" }}>
            <Pill size={26} className="text-white" />
          </div>
          <div>
            <h1 className="font-display text-[22px] font-normal text-white">Medications</h1>
            <p className="font-body text-[14px]" style={{ color: "rgba(255,255,255,0.7)" }}>{takenCount} of {margaret.medications.length} taken today</p>
          </div>
        </div>
        {/* Progress bar */}
        <div className="w-full h-[6px] rounded-full" style={{ background: "rgba(255,255,255,0.15)" }}>
